...
rul-router .- integrates .-> app-router
rul-router .- integrates .-> expo-router
rul-image .- integrates .-> next-image
rul-image .- integrates .-> expo-image
rul-auth .- integrates .-> next-auth
rul-auth .- integrates .-> expo-auth
```
